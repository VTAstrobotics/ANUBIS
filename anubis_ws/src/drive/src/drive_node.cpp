...
private:
  ...
  void left_feedback_callback(motor_messages::msg::Feedback::SharedPtr msg, std::string motor_name)
  {
    odom_mutex.lock();
  ...
  void right_feedback_callback(motor_messages::msg::Feedback::SharedPtr msg, std::string motor_name)
  {
    odom_mutex.lock();
