...
#ifndef MOTOR_MESSAGES__MSG__DETAIL__COMMAND__TRAITS_HPP_
#define MOTOR_MESSAGES__MSG__DETAIL__COMMAND__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "dutycycle: ";
    to_flow_style_yaml(msg.dutycycle, out);
  }
  out << "}";
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: dutycycle
  {
    ...
    out << "dutycycle:\n";
    to_block_style_yaml(msg.dutycycle, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
...
inline void to_yaml(
  const motor_messages::msg::Command & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const motor_messages::msg::Command & msg)
{
  return motor_messages::msg::to_yaml(msg);
}

template<>
inline const char * data_type<motor_messages::msg::Command>()
{
  return "motor_messages::msg::Command";
}

template<>
inline const char * name<motor_messages::msg::Command>()
{
  return "motor_messages/msg/Command";
}

template<>
struct has_fixed_size<motor_messages::msg::Command>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Float32>::value> {};

template<>
struct has_bounded_size<motor_messages::msg::Command>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Float32>::value> {};

template<>
struct is_message<motor_messages::msg::Command>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MOTOR_MESSAGES__MSG__DETAIL__COMMAND__TRAITS_HPP_
