...
{
  new (message_memory) motor_messages::msg::Command(_init);
}

void Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<motor_messages::msg::Command *>(message_memory);
  typed_message->~Command();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_message_member_array[4] = {
  {
    "velocity",  // name
    ...
    offsetof(motor_messages::msg::Command, velocity),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_messages::msg::Command, current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_messages::msg::Command, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_messages::msg::Command, dutycycle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_message_members = {
  ...
  4,  // number of fields
  sizeof(motor_messages::msg::Command),
...
get_message_type_support_handle<motor_messages::msg::Command>()
{
  return &::motor_messages::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_messages, msg, Command)() {
  return &::motor_messages::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
