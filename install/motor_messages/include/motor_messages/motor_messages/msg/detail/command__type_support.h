...
#ifndef MOTOR_MESSAGES__MSG__DETAIL__COMMAND__TYPE_SUPPORT_H_
#define MOTOR_MESSAGES__MSG__DETAIL__COMMAND__TYPE_SUPPORT_H_
...
#endif  // MOTOR_MESSAGES__MSG__DETAIL__COMMAND__TYPE_SUPPORT_H_
