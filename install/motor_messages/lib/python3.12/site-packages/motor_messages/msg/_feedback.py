...
class Feedback(metaclass=Metaclass_Feedback):
    ...
    _fields_and_field_types = {
        ...
        'position': 'std_msgs/Float32',
        'is_disabled': 'std_msgs/Bool',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float32
        self.position = kwargs.get('position', Float32())
        from std_msgs.msg import Bool
        self.is_disabled = kwargs.get('is_disabled', Bool())
    ...
    def position(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Float32), \
                "The 'position' field must be a sub message of type 'Float32'"
        self._position = value

    @builtins.property
    def is_disabled(self):
        """Message field 'is_disabled'."""
    ...
    def is_disabled(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'is_disabled' field must be a sub message of type 'Bool'"
